...
This process can lead to a phenomenon \textcite{arya_cultural_2021} calls the ``pizza effect'' or ``re-enculturation''. The term, coined by the anthropologist \textcite{bharati_hindu_1970}, derives from the curious historical trajectory of the pizza. Originally, the pizza was a simple, humble foodstuff consumed by the poor in Naples. However, when Italian immigrants took it to the United States, it was transformed and embellished with elaborate toppings, evolving into a substantial dish. This Americanized, commodified version was subsequently exported back to Italy, where it was embraced with a prestige it never originally held. The ``new'' pizza displaced the traditional form, effectively causing the culture to re-learn its own heritage through a foreign lens \parencite{arya_cultural_2021}.
...
This practice is not merely superficial; it thrives on a harmful double standard. As \textcite{hooks_black_2014} argues (as cited in \cite{arya_cultural_2021}), members of marginalized groups are often ostracized, stereotyped, or racially profiled for displaying these very markers of difference. Yet, when these same symbols are displaced onto a digital interface designed by the dominant culture, they are suddenly celebrated as ``exotic,'' ``desirable,'' and ``edgy.'' By treating these symbols as mere aesthetic assets, the designer strips them of their historical and social weight, reinforcing the ``asymmetry of power'' where the dominant culture defines what is ``cool'' without bearing the burden of the oppression associated with those symbols.
...
Designers must therefore be cognizant of how their products might encourage shallow cultural interpretations or reinforce detrimental beliefs in their audience. This expanded obligation requires a move toward a design process that actively manages these cultural interpretations rather than simply applying a superficial cultural ``skin'' to a product.
