...
This aligns with what \textcite{arya_cultural_2021} identifies as cultural imperialism. This is not just about economic dominance, but the power to define cultural value. The dominant culture has the privilege of deciding which parts of a marginalized culture are aesthetic or valuable enough to be extracted, while simultaneously devaluing the people who created them. In the context of UX, this imperialism manifests when Western design standards are treated as the universal default, and other cultural elements are merely harvested to decorate that~default.
